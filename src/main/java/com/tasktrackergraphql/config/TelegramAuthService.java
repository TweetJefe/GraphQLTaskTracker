...
public class TelegramAuthService {
    ...
    public boolean validateInitData(String initData, Long telegramId){
        try {
            ...
            if (!calculatedHash.equals(recievedHash)) {
                return false;
            }
            ...
            com.fasterxml.jackson.databind.JsonNode userNode = mapper.readTree(userJson);
            if (userNode.has("id")) {
                long idInJson = userNode.get("id").asLong();
                return idInJson == telegramId;
            }
